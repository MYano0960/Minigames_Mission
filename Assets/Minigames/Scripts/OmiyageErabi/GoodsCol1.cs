...
public class GoodsCol1 : MonoBehaviour
{
    Rigidbody2D rb;
    ...
    void Start()
    {
        ...
        g_point1 = GameObject.Find("G_Point1").transform.position;
    ...
    private void OnTriggerExit2D(Collider2D col) 
    {
        if (col.gameObject.name == "Table"){
            ...
            if (!not_dupli){
                if (!isQuitting){
                    Instantiate(thisobj, new Vector3(g_point1.x, g_point1.y, 0), Quaternion.identity);
                }
            }
        }
    }
    ...
    public int GetEntry1{
        get{return entry_goods1;}
        set{entry_goods1 = value;}
    }
}
